package com.belajar.pekanbaruapps.screen.detailkesehatan.screen
...
fun DetailKesehatan(
    ...
    vm: DetailKesehatanViewModel,
    kesehatanName: String
) {

    vm.getRestaurantByName(kesehatanName)
    ...
    Scaffold(
        ...
        bottomBar = {
            ButtonTraveloka("Kunjungi Web Resmi")
        },
