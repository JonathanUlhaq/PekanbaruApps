package com.belajar.pekanbaruapps.screen.pendidikan.smp.screen
...
@Composable
fun SMPScreen(uiState: List<SMPModel>, navController: NavController) {
    LazyColumn(content = {
        items(uiState) {
            Card(
                modifier = Modifier
                    ...
                    .clickable {
                        navController.navigate(AppRoute.SMPDetail.route + "/${it.name}")
                    },
