package com.belajar.pekanbaruapps.widgets.pembelanjaanscreen
...
@Composable
fun ListBelanja(uiState: List<BelanjaModel>, navController: NavController) {
    LazyColumn(content = {
        items(uiState) {
            ...
            Card(
                modifier = Modifier
                    ...
                    .clickable {
                        navController.navigate(AppRoute.BelanjaDetail.route + "/${it.nama}")
                    },
